## Your Network
Today we rely on Google and other Big Tech companies to connect our devices in order to sync photos, email, and documents. In fact all our apps today always go via some central player. We pay the price of for this convenience with lost privacy as we put ourselves under non-stop corporate surveilance. 
